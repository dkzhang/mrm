...
func (e RoomEdges) MdrsOrErr() ([]*MeetingDateRoom, error) {
	if e.loadedTypes[0] {
		return e.Mdrs, nil
	}
...
// QueryMdrs queries the "mdrs" edge of the Room entity.
func (r *Room) QueryMdrs() *MeetingDateRoomQuery {
	return NewRoomClient(r.config).QueryMdrs(r)
}
